...
namespace FlightInfrastructure.Repositories
{
    public class PlaneRepository : IPlaneRepository
    {
        ...
        public async Task<FlightBooking?> FindFlightBooking(Guid UserId, Guid FlightId)
        {
            var result = await _db.FlightBooks.FirstOrDefaultAsync(a => a.UserId == UserId && a.FlightId == FlightId);
            return result;
        }
